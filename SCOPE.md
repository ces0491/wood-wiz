...
- **Getting past a vendor's bot protection.** A vendor whose site or host refuses the scraper is not listed. Disguising the scraper, solving or bypassing challenges, and scraping from other networks to route around a block all override a choice the vendor or their host made. The route back is the vendor allowing it.
